...
public class ChessBoard extends Pane implements Initializable {
	...
	public void selectnMovePiece(final double x, final double y) throws IOException {
		int indexX = (int) (x/ cell_width);
		int indexY = (int) (y/ cell_height);
	...
	// move piece method
	public void movePiece(final double x, final double y) throws IOException {
		int indexX = (int) (x/ cell_width);
		int indexY = (int) (y/ cell_height);
	...
	public static Account playerOne; // player White
	public static Account playerTwo; // player Black
